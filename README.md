...
| [`turnover-analyst`](skills/retaining/turnover-analyst/) | Breaks down 30, 60 and 90-day attrition by location, manager, source and role, and separates whether you have a hiring problem or a job problem. | needs a CSV export, 0.3 MB |
